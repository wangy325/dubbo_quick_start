...
```
Exception in thread "main" com.alibaba.dubbo.rpc.RpcException: Forbid consumer 192.168.35.1 access service
 wy.dubbo.api.DemoService from registry 127.0.0.1:2181 use dubbo version 2.5.3, Please check registry access
